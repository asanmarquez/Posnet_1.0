...
public class Posnet {
    ...
    public void Regresion (ChromeDriver controlador, String producto) throws Exception {
		...
		Thread.sleep(1500);
		controlador.findElement(By.xpath("//*[@id='frmSelectProductos:canalSocioCanalVenta']/tbody/tr[1]/td[1]/div/div[2]")).click();
		File scrFile0007 = ((TakesScreenshot)controlador).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrFile0007, new File("d:\\Evidencias_Automatizacion\\Vida\\Seleccion Producto.png"));
		Thread.sleep(1500);
		controlador.findElement(By.xpath("//*[@id='frmSelectProductos:cmdNext']/div")).click();
		Thread.sleep(40000);
		System.out.println("----------Seleccion de Plan -------------");
		...
		controlador.findElement(By.xpath("//*[@id='frmCatProductos:j_id3']/div[2]")).click();
		Thread.sleep(1500);
		File scrFile0008 = ((TakesScreenshot)controlador).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrFile0008, new File("d:\\Evidencias_Automatizacion\\Vida\\Seleccion Plan 2.png"));
		controlador.findElement(By.xpath("//*[@id='frmCatProductos:cmdNext']/div")).click();
		Thread.sleep(1500);
		System.out.println("------Ingresando Datos Contratante-------");
		System.out.println("-----------------------------------------");
		...
		Thread.sleep(2000);
		controlador.findElement(By.xpath("//*[@id='frmAsegurado:menuColonias_panel']/div/ul/li[2]")).click();
		File scrFil0e009 = ((TakesScreenshot)controlador).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrFil0e009, new File("d:\\Evidencias_Automatizacion\\Vida\\Datos del Contratante Plan 2.png"));
		controlador.findElement(By.xpath("//*[@id='frmAsegurado:btnAsegNext']/div")).click();
		Thread.sleep(2000);
		System.out.println("------Agregando Beneficiarios------------");
		System.out.println("-----------------------------------------");
		...
		controlador.findElement(By.xpath("//*[@id='frmCobros:menuBancos_panel']/div/ul/li[2]")).click();
		Thread.sleep(2000);
		File scrFile00010 = ((TakesScreenshot)controlador).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrFile00010, new File("d:\\Evidencias_Automatizacion\\Vida\\Medio de Pago Plan 2.png"));
		Thread.sleep(2000);
		controlador.findElement(By.xpath("//*[@id='frmCobros:cmdNext']/div")).click();
		File scrFile00011 = ((TakesScreenshot)controlador).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrFile00011, new File("d:\\Evidencias_Automatizacion\\Vida\\Medio de Pago_1 Plan 2.png"));
		Thread.sleep(2000);
		System.out.println("----------Confirmacion de Datos----------");
		System.out.println("-----------------------------------------");
		controlador.findElement(By.id("formVentaConfirm:aceptaDatos")).click();
		...
		controlador.findElement(By.id("frmValidate:Btnconfirmar")).click();
		Thread.sleep(4000);
		File scrFile00012 = ((TakesScreenshot)controlador).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrFile00012, new File("d:\\Evidencias_Automatizacion\\Vida\\Tramite Exitoso Plan 2.png"));
		controlador.findElement(By.id("frmVenta:cmdPrint")).click();
		System.out.println("--------------Venta Exitosa--------------");
		System.out.println("-------------Cuenta Cheques--------------");
		Thread.sleep(10000);
