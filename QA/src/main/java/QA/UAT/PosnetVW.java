...
public class PosnetVW {
	...
	public void Venta_VW_Bank_Nuevos (ChromeDriver controlador, String producto) throws Exception {
		...
		System.out.println("-----------------------------------------");
		controlador.findElement(By.name("j_idt26")).sendKeys("2014042847");
		Thread.sleep(1000);
		...
		controlador.findElement(By.id("frmSelectProductos:valorFactura")).sendKeys("30000000");
		Thread.sleep(1500);
		controlador.findElement(By.xpath("//*[@id='frmSelectProductos:cmdNext']/div")).click();
		Thread.sleep(1500);
		...
		System.out.println("-----------------------------------------");
		controlador.findElement(By.id("marca")).sendKeys("VW");
		controlador.findElement(By.id("modelo")).sendKeys("Jetta");
		controlador.findElement(By.id("anio")).sendKeys("2021");
		controlador.findElement(By.id("numeroSerie")).sendKeys("3VW3W202020202020");
		controlador.findElement(By.id("numeroMotor")).sendKeys("Hecho en Mexico");
		controlador.findElement(By.xpath("//*[@id='cmdNext']/div")).click();
		Thread.sleep(1500);
		controlador.findElement(By.id("frmOtrosCampos:tablaCamposExtras:0:inputCampoExtra")).sendKeys("VW");
		controlador.findElement(By.id("frmOtrosCampos:tablaCamposExtras:1:inputCampoExtra")).sendKeys("65465465");
		controlador.findElement(By.id("frmOtrosCampos:tablaCamposExtras:2:inputCampoExtra")).sendKeys("ANGEL SANCHEZ");
		controlador.findElement(By.id("frmOtrosCampos:tablaCamposExtras:3:inputCampoExtra")).sendKeys("angel@qa.com");
		controlador.findElement(By.xpath("//*[@id='frmOtrosCampos:cmdNext']/div")).click();
		Thread.sleep(1500);
		System.out.println("--------------Marca del Auto-------------");
		System.out.println("-----------------------------------------");
		controlador.findElement(By.id("frmAsegurado:inputNombre")).sendKeys("BANK NUEVOS");
		...
		controlador.findElement(By.id("frmAsegurado:inputNumCliente")).sendKeys("6546546");
		...
		Thread.sleep(1500);
		controlador.findElement(By.id("frmCobros:mes")).sendKeys("60");
    ...
    public void Venta_VW_Bank_Usados (ChromeDriver controlador, String producto) throws Exception {
		...
		System.out.println("--------------Marca del Auto-------------");
		System.out.println("-----------------------------------------");
		controlador.findElement(By.id("frmAsegurado:inputNombre")).sendKeys("BANK USADOS                                                   ");
		controlador.findElement(By.id("frmAsegurado:inputAPaterno")).sendKeys("Test");
		controlador.findElement(By.id("frmAsegurado:inputAMaterno")).sendKeys("Test");
		controlador.findElement(By.id("frmAsegurado:popupfhNac_input")).sendKeys("31/05/1988");
		controlador.findElement(By.id("frmAsegurado:inputNumCliente")).sendKeys("6546546");
    ...
    public void Venta_VW_Pago_de_contado_Nuevos (ChromeDriver controlador, String producto) throws Exception {
    ...
    public void Venta_VW_Pago_de_contado_usados (ChromeDriver controlador, String producto) throws Exception {
